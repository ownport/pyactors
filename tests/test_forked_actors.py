...
def test_processing_with_children():
    ''' test_forked_actors.test_processing_with_children
    '''    
    test_name = 'test_forked_actors.test_processing_with_children'
    logger = file_logger(test_name, filename='logs/%s.log' % test_name) 
...
def test_stop_children_in_the_middle():
    ''' test_forked_actors.test_stop_children_in_the_middle
    '''    
    ...
    test_name = 'test_forked_actors.test_stop_children_in_the_middle'
    logger = file_logger(test_name, filename='logs/%s.log' % test_name) 
...
def test_processing_with_diff_timelife_children():
    ''' test_forked_actors.test_processing_with_diff_timelife_children
    '''    
    test_name = 'test_forked_actors.test_processing_with_diff_timelife_children'
    logger = file_logger(test_name, filename='logs/%s.log' % test_name) 
...
def test_send_msg_between_actors():
    ''' test_forked_actors.test_send_msg_between_actors
    '''        
    test_name = 'test_forked_actors.test_send_msg_between_actors'
    logger = file_logger(test_name, filename='logs/%s.log' % test_name) 
...
def test_send_stop_msg_to_child():
    ''' test_forked_actors.test_send_stop_msg_to_child
    '''        
    class Parent(pyactors.actor.Actor):
        def __init__(self, name, logger):
            ''' __init__
    ...
    test_name = 'test_forked_actors.test_send_stop_msg_to_child'
    logger = file_logger(test_name, filename='logs/%s.log' % test_name) 
    parent = Parent(name='Parent', logger=logger)      
    for i in range(5):
        child = TestForkedGeneratorActor(name='Child-%d' % i, logger=logger)
...
def test_send_wrong_system_msg():
    ''' test_forked_actors.test_send_wrong_system_msg
    '''        
    class Parent(pyactors.actor.Actor):
        def __init__(self, name, logger):
            ''' __init__
    ...
    test_name = 'test_forked_actors.test_send_wrong_system_msg'
    logger = file_logger(test_name, filename='logs/%s.log' % test_name) 
    parent = Parent(name='Parent', logger=logger)      
